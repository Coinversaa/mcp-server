...
describe("MCP Server", () => {
  ...
  describe("Free-Tier Tools", () => {
    ...
    const safeParseResult = (result: any) => {
    ...
    test(
      "pulse_global_stats should return data",
      async () => {
    ...
    test(
      "pulse_market_overview should return market data",
      async () => {
        const result = await client.callTool({
    ...
    test(
      "list_markets should return all markets",
      async () => {
        const result = await client.callTool({
          name: "list_markets",
          arguments: { useToonFormat: false },
    ...
    test(
      "market_price should return price for native symbol",
      async () => {
        const result = await client.callTool({
          name: "market_price",
    ...
    test(
      "market_price should return price for builder dex symbol",
      async () => {
        const result = await client.callTool({
          name: "market_price",
    ...
    test(
      "market_orderbook should return order book data",
      async () => {
        const result = await client.callTool({
    ...
    test(
      "pulse_most_traded_coins should return trending coins",
      async () => {
        const result = await client.callTool({
    ...
    test(
      "live_long_short_ratio should return ratio data",
      async () => {
        const result = await client.callTool({
  ...
  describe("Authenticated Tools (require API key)", () => {
    ...
    conditionalTest(
      "pulse_leaderboard should return ranked traders",
      async () => {
        const result = await client.callTool({
    ...
    conditionalTest(
      "pulse_trader_profile should return trader data",
      async () => {
        const result = await client.callTool({
    ...
    conditionalTest(
      "market_positions should return wallet positions",
      async () => {
        const result = await client.callTool({
    ...
    conditionalTest(
      "pulse_cohort_summary should return cohort analysis",
      async () => {
        const result = await client.callTool({
    ...
    conditionalTest(
      "live_liquidation_heatmap should return heatmap data",
      async () => {
        const result = await client.callTool({
    ...
    conditionalTest(
      "live_cohort_bias should return bias data",
      async () => {
        const result = await client.callTool({
    ...
    conditionalTest(
      "pulse_recent_trades should return recent trades",
      async () => {
        const result = await client.callTool({
    ...
    conditionalTest(
      "live_recent_liquidations should return liquidation data",
      async () => {
        const result = await client.callTool({
