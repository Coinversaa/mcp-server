...
function requireApiKey(req, res) {
    ...
    if (apiKey)
        return apiKey;
    jsonRpcError(res, 401, -32001, "Coinversa API key required. Send Authorization: Bearer <key> or X-API-Key.");
    return undefined;
}
function createServerForRequest(req) {
...
app.options(["/mcp", "/sse", "/messages"], (_req, res) => {
