...
- The list_markets tool accepts an optional dex filter to narrow results`;
    ...
    if (shouldRegister("builder_journey"))
        ...
        }, async ({ useToonFormat, builder }) => toolResult(await callAPI(useToonFormat, `/builders/${builder}/journey`)));
    ...
    if (shouldRegister("builder_heatmap"))
        ...
        }, async ({ useToonFormat, builder }) => toolResult(await callAPI(useToonFormat, `/builders/${builder}/heatmap`)));
